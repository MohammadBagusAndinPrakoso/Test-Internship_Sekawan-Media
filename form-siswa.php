                ...
                <ul>
                    <?php
                        ...
                        if (isset($_GET["id"])) {
                            ...
                            <form action="process-siswa.php" method="post" 
                            ...
                            onsubmit="return confirm('Apakah anda yakin ingin mengubah data ini?')">
                               ...
                               <input type="text" name="alamat"
                                ...
                                <button type="submit" class="btn btn-success btn-block mt-4" name="edit_siswa">
                                    Simpan
                                </button>
                            </form>
                            <?php
                            ...
                            enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-success btn-block" name="simpan_siswa">
                                    Simpan
                                </button>
                            </form>
